...
public class ModuleAdapter extends RecyclerView.Adapter<ModuleAdapter.ModuleViewHolder> {
    ...
    public ModuleAdapter(List<ModuleListInfo> modulesList, Activity appActivity) {
    ...
    @Override
    public ModuleAdapter.ModuleViewHolder onCreateViewHolder(ViewGroup parent,
                                                         int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(ModuleViewHolder holder, int position) {
        ...
        if (moduleId.equals("_read")) {
            holder.rowDeleteButton.setVisibility(View.INVISIBLE);
            holder.textView.setGravity(Gravity.CENTER_VERTICAL | Gravity.START);
        } else {
            holder.textView.setGravity(Gravity.CENTER_VERTICAL | Gravity.CENTER);
